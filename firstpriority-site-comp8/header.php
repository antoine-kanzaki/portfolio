...
<head>
  ...
  <meta name=”description” content=”患者と医療提供者の距離を縮め、医療へのアクセスをよりスムーズにすることで、人々の健康と生活の質を向上させることを存在意義としています。また、医療におけるオンラインとオフラインを融合したサービスを提供することで、人々が医療にアクセスしやすくなります。”>
...
<body <?php body_class(); ?>>
    ...
    <header>
      ...
      <div class="header-bottom-set">
        <a class="bottom-section-button js-scrollify-move" href="#section1">
          <div class="bottom-section-name">コンセプト</div>
          <div class="bottom-name-sub">consept</div>
        </a>
        <div class="header-border"></div>
        <a class="bottom-section-button promiseroop js-scrollify-move" href="#section4">
        ...
        <div class="drop-menu-set">
          <a class="bottom-section-button companyroop js-scrollify-move" href="#section5">
            <div class="bottom-section-name drop-menu-1">会社概要<span>▾<span></div>
            <div class="bottom-name-sub">overview</div>
          </a>
            <ul>
              <li><a href="#section5" class="messageroop js-scrollify-move">代表<br class="dropdown-indent">メッセージ</a></li>
              <li><a href="#section6" class="repprofileroop js-scrollify-move">代表<br class="dropdown-indent">プロフィール</a></li>
              <li><a href="#section7" class="exeprofileroop js-scrollify-move">役員<br class="dropdown-indent">プロフィール</a></li>
              <li><a href="#section13" class="fireinforoop js-scrollify-move">会社情報</a></li>
            </ul>
        </div>

          <a class="bottom-section-button for-extra-smartphone-menu companyroop js-scrollify-move" href="#section5">
